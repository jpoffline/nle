...
\bea
\eta_{ab} = n^{-2/3} k_{AB} \partial_a\phi^A\partial_b\phi^B \rightarrow \frac{1}{M^2}n^{-2/3} k_{AB} \partial_a\phi^A\partial_b\phi^B.
\eea
Hence, the $\qsuprm{n}{th}$-trace of $\gbm{\eta}$ carries $2n$-powers of $M$,
\bea
[\gbm{\eta}^n] \rightarrow \frac{1}{M^{2n}}[\gbm{\eta}^n].
\eea
Also,
\bea
{C^a}_b{}^c  \rightarrow \frac{1}{M^3}{C^a}_b{}^c.
\eea
{\bf Is this true? $\eta$ has unit determinant, which links the cubic and quadratic invariants...}
Hence, $n$-copies of allowed contractions of ${C^a}_{b}{}^c$ and $m$ of $\nabla\phi$ are replaced with
\bea
(\nabla\phi)^m(C)^n \rightarrow \frac{1}{M^{m + 3n}}(\nabla\phi)^m(C)^n.
\eea
Then we can form
\bea
