...
\newcommand{\qsupbrm}[3]{{#1}^{\scriptscriptstyle{\textrm{#2}}}_{\scriptscriptstyle{\textrm{#3}}}}
...
\newcommand{\rol}[0]{\mathcal{R}_{\scriptscriptstyle\{2\}}}
...
\newcommand{\matmanif}[0]{\mathcal{M}} 
